...
import edu.kit.compiler.wrapper.wrappers.AbstractVisitor
...
private val ILLEGAL_SOURCE_POSITION = SourcePosition(ILLEGAL_SOURCE_FILE, 0)

private val ILLEGAL_SOURCE_RANGE = SourceRange(ILLEGAL_SOURCE_POSITION, 0)

/**
 * Visitor to replace all source ranges with mock ranges
 */
class WipeSourceRangeVisitor() : AbstractVisitor() {
