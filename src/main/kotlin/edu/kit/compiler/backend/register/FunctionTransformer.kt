...
interface FunctionTransformer {
    ...
    /**
     * Transform a given block of code into [PlatformIR] by allocating registers and generating necessary platform-specifc
     ...
     */
    fun transformCode(codeBlock: List<MolkirInstruction>)
